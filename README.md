...
- **Макросы**: Гигиенические макросы через `define-macro`. Встроенные макросы: `let`, `and`, `or`.
...
- **Обработка ошибок**: Информативные сообщения об ошибках с использованием кастомных классов исключений. Поддержка `try` и `raise`.
