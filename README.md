...
[![asciicast](https://asciinema.org/a/3aktezFCZWg9h0ajPeRi0nTp8.svg)](https://asciinema.org/a/3aktezFCZWg9h0ajPeRi0nTp8)
...
*   **Классы ошибок**: В `errors.py` определены типы ошибок (`LispyError`, `SyntaxError` и т.д.).
